import{u as T,_ as l}from"./index-BI5LrOG5.js";import{_ as y}from"./_plugin-vue_export-helper-DlAUqK2U.js";import{f as a,p as t,x as o,u as f,F as n,i as h,e as s,j as k,t as c,v as r,q as u}from"./vendor-vue-o2mYqWBf.js";const b={class:"header"},E={class:"toc"},S=["href"],W=["id"],w={class:"section-title"},J={class:"ep-header"},_={class:"ep-path"},G={key:0,class:"ep-auth"},P={key:1,class:"ep-auth public"},g={class:"ep-desc"},O={key:0,class:"ep-curl"},v={key:1,class:"ep-resp"},A={__name:"ApiDocs",setup(H){const{t:m}=T(),d=[{id:"auth",label:"认证 Auth",endpoints:[{method:"POST",path:"/api/auth/register",auth:!1,desc:"注册新用户，返回 JWT token",curl:`curl -X POST http://localhost:3120/api/auth/register \\
